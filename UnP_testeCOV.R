...
employ=~EMPL_02_EMPL_02_01+EMPL_02_EMPL_02_02+EMPL_02_EMPL_02_03+EMPL_02_EMPL_02_04+EMPL_02_EMPL_02_05+EMPL_02_EMPL_02_06
financial_serv=~FSERV_01_FSERV_01_01+FSERV_01_FSERV_01_02+FSERV_01_FSERV_01_03+FSERV_01_FSERV_01_04+FSERV_01_FSERV_01_05
...
SAT_00_02~infra+image+faculty+inter+std_services+comunic+program+financial_serv+financial_serv+employ+call+coord
...
for(q in 1:length(quebras)){
  ...
  for(lev in 1:length(niv)){  
    ...
    fileName<-paste("UnPTeste",paste(nivel_label,"resultados_SEM.xlsx",sep="_"))
    ...
    fileGraph <- paste(nivel_label,'UnPTestegraph.png',sep="_")
    ...
    saveWorkbook(exc)
    drop_upload(paste("UnPTeste",fileName))
    
  }
}

save.image("UnPTeste.RData")
history("UnPTeste.Rhistory")
